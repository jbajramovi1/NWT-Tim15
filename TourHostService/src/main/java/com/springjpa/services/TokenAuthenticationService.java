...
public class TokenAuthenticationService {
	...
	private static TourHostRepository repository;
    ...
    public static void addAuthentication(HttpServletRequest req, HttpServletResponse res, String username) {
        ...
        res.addHeader("Roles", repository.findByUsernameTourHost(username).getRole());
    }
    ...
    public static Authentication getAuthentication(HttpServletRequest request) {
        ...
        repository = webApplicationContext.getBean(TourHostRepository.class);
        ...
        if (token != null) {
            ...
            TourHost userAccount = repository.findByUsernameTourHost(user);
