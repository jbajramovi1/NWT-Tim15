...
import com.example.demo.repo.TourHostExternalLinkRepository;
import com.example.demo.repo.TourHostLocationRepository;
import com.example.demo.repo.TourHostPaymentInfoRepository;
...
public class AdditionalInfoService {
    ...
    /**public ResponseEntity<Object> removeExternalLink(int id) {
    	Optional<TourHostExternalLink> myLink = linksRepo.findById(id);
    	if (myLink==null)
