...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String s) throws UsernameNotFoundException {
        ...
        com.example.demo.model.User userAccount = userRepository.findByUsername(s);
        if(userAccount == null) {
    ...
    private Collection<GrantedAuthority> getGrantedAuthorities(com.example.demo.model.User userAccount) {
